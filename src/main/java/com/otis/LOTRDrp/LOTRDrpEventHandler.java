...
public class LOTRDrpEventHandler {
    ...
    public void connectedToServer(FMLNetworkEvent.ClientConnectedToServerEvent e) {
        ...
        if (!e.isLocal && LOTRDrpConfig.cfgEnableServers) {
            ...
            if (Minecraft.getMinecraft().func_147104_D().serverIP.equalsIgnoreCase("148.251.40.254:25652") || Minecraft.getMinecraft().func_147104_D().serverIP.equalsIgnoreCase("harda.tournier.org:25575")) {
            ...
            }else if (Minecraft.getMinecraft().func_147104_D().serverIP.contains("LOTRSiege.beastmc.com")) {
                LOTRDrpMain.drp.setPlayingOnSupportedServer(true);
                LOTRDrpMain.drp.discord.updateImages(null, "siege");
                LOTRDrpMain.drp.discord.updateText("The LOTR Siege Server", "Playing Server " + Minecraft.getMinecraft().func_147104_D().serverIP.toString());
                LOTRDrpMain.drp.discord.updateState(
                        "The LOTR Siege Server",
                        Minecraft.getMinecraft().func_147104_D().serverIP.toString()

                );
                LOTRDrpMain.OTISLog(Minecraft.getMinecraft().getSession().getUsername() + "'s Pressence Is Now Set To Siege Theme");
                ...
                LOTRDrpMain.OTISLog(Minecraft.getMinecraft().getSession().getUsername() + "'s Pressence Is Now Set To Second Server Theme");
            ...
            }else if (Minecraft.getMinecraft().func_147104_D().serverIP.contains("142.44.191.74:28298")) {
                        LOTRDrpMain.drp.setPlayingOnSupportedServer(true);
                        LOTRDrpMain.drp.discord.updateImages("spark", LOTRDrpMain.theme);
                        LOTRDrpMain.drp.discord.updateText("Spark of Arda", "Playing Server " + Minecraft.getMinecraft().func_147104_D().serverIP.toString());
                        LOTRDrpMain.drp.discord.updateState(
                                "Spark of Arda",
                                Minecraft.getMinecraft().func_147104_D().serverIP.toString()
                    ...
                    }else if (Minecraft.getMinecraft().func_147104_D().serverIP.contains("dominion.g.akliz.net")) {
                        LOTRDrpMain.drp.setPlayingOnSupportedServer(true);
                        LOTRDrpMain.drp.discord.updateImages("dome", LOTRDrpMain.theme);
                        LOTRDrpMain.drp.discord.updateText("Dominion of Middle-Earth", "Playing Server " + Minecraft.getMinecraft().func_147104_D().serverIP.toString());
                        LOTRDrpMain.drp.discord.updateState(
